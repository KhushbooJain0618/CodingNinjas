...
export default function AdminDashboard() {
  ...
  const handleResumeDownload = async (url: string, filename: string) => {
    try {
      ...
      link.download = filename || 'resume'; // Provide a fallback filename
      ...
      alert("Failed to download resume."); // Inform the user
    }
  };
        ...
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-zinc-800">
            {applications.map((app, index) => {
              // Extract the filename from the URL to use in the download attribute.
                ...
                >
                  ...
                  <td className="px-4 py-4 text-sm text-center">
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <button
                        onClick={() =>
                          openDeleteModal(app._id, "application")
                        }
                ...
                <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-6 sticky top-8">
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-full flex-shrink-0 py-3 px-6 bg-orange-500 text-black font-bold rounded-xl hover:bg-orange-600 transition-all duration-300 disabled:opacity-50 flex items-center justify-center gap-2"
                    >
                  ...
                  <div className="space-y-3 max-h-96 overflow-y-auto">
                    {careers.length > 0 ? (
                      ...
                      <p className="text-center text-gray-500 py-4">
                        No career openings found. Add one above.
                      </p>
                    )}
                  </div>
                </div>
