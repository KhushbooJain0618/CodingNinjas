          ...
          <div className="relative z-10">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                <div className="flex flex-col gap-2">
                    ...
                    <input name="name" type="text" placeholder="Name" value={form.name} readOnly className="w-full p-4 rounded-xl bg-zinc-900 border border-zinc-700 text-gray-400 placeholder-gray-600 cursor-not-allowed" required />
                </div>
                <div className="flex flex-col gap-2">
                    <label className="text-sm font-medium text-gray-400">Chitkara Mail ID</label>
                    <input name="chitkaraEmail" type="email" placeholder="Chitkara Mail ID" value={form.chitkaraEmail} readOnly className="w-full p-4 rounded-xl bg-zinc-900 border border-zinc-700 text-gray-400 placeholder-gray-600 cursor-not-allowed" required />
                </div>
                <div className="flex flex-col gap-2">
                    <label className="text-sm font-medium text-gray-400">Roll Number</label>
                    <input name="rollNumber" type="text" placeholder="Roll Number" value={form.rollNumber} onChange={handleChange} className="w-full p-4 rounded-xl bg-black border border-zinc-700 focus:border-orange-500 focus:outline-none text-white placeholder-gray-600 transition-all duration-300" required />
                </div>
                <div className="flex flex-col gap-2">
                    <label className="text-sm font-medium text-gray-400">Contact Number</label>
                    <input name="contactNumber" type="tel" placeholder="Enter your contact number" value={form.contactNumber} onChange={handleChange} className="w-full p-4 rounded-xl bg-black border border-zinc-700 focus:border-orange-500 focus:outline-none text-white placeholder-gray-600 transition-all duration-300" required pattern="[0-9]{10}" />
                </div>
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex gap-6">
                        {["Male", "Female", "Other"].map((g) => (
                            <label key={g} className="flex items-center gap-2 cursor-pointer">
                                <input type="radio" name="gender" value={g} checked={form.gender === g} onChange={handleChange} className="w-4 h-4 accent-orange-500" required />
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <input name="department" type="text" placeholder="Department" value={form.department} onChange={handleChange} className="w-full p-4 rounded-xl bg-black border border-zinc-700 focus:border-orange-500 focus:outline-none text-white placeholder-gray-600 transition-all duration-300" required />
                </div>
                <div className="flex flex-col gap-2">
                    <label className="text-sm font-medium text-gray-400">Group</label>
                    <input name="group" type="text" placeholder="Group" value={form.group} onChange={handleChange} className="w-full p-4 rounded-xl bg-black border border-zinc-700 focus:border-orange-500 focus:outline-none text-white placeholder-gray-600 transition-all duration-300" required />
                </div>
                <div className="flex flex-col gap-2">
                    <label className="text-sm font-medium text-gray-400">Specialization</label>
                    <input name="specialization" type="text" placeholder="Specialization" value={form.specialization} onChange={handleChange} className="w-full p-4 rounded-xl bg-black border border-zinc-700 focus:border-orange-500 focus:outline-none text-white placeholder-gray-600 transition-all duration-300" required />
                </div>
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex gap-6">
                        {["Hosteller", "Day Scholar"].map((h) => (
                            <label key={h} className="flex items-center gap-2 cursor-pointer">
                                <input type="radio" name="hosteller" value={h} checked={form.hosteller === h} onChange={handleChange} className="w-4 h-4 accent-orange-500" required />
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <input name="position" type="text" placeholder="Position" value={form.position} readOnly className="w-full p-4 rounded-xl bg-zinc-900 border border-zinc-700 text-gray-400 placeholder-gray-600 cursor-not-allowed" required />
                </div>
                <div className="flex flex-col gap-2">
                    <label className="text-sm font-medium text-gray-400">Role</label>
                    <input name="role" type="text" placeholder="Role" value={form.role} readOnly className="w-full p-4 rounded-xl bg-zinc-900 border border-zinc-700 text-gray-400 placeholder-gray-600 cursor-not-allowed" required />
                </div>
              <div className="flex flex-col gap-2">
                <label className="text-sm font-medium text-gray-400">Resume (PDF Only)</label>
                <input
                  type="file"
                  accept=".pdf"
